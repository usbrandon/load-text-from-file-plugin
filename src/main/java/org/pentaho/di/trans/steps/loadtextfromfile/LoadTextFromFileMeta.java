...
public class LoadTextFromFileMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public String getXML() {
    ...
    retval.append( "    " ).append( XMLHandler.addTagValue( "metadataFieldName", metadataFieldName ) );
  ...
  private void readData( Node stepnode ) throws KettleXMLException {
    try {
      ...
      metadataFieldName = XMLHandler.getTagValue( stepnode, "metadataFieldName" );
  ...
  public void getFields( RowMetaInterface r, String name, RowMetaInterface info[], StepMeta nextStep, VariableSpace space, Repository repository,
    ...
    if ( isHiddenField() != null && isHiddenField().length() > 0 ) {
      ValueMetaInterface v = new ValueMetaString( space.environmentSubstitute( isHiddenField() ));
      v.setOrigin( name );
      r.addValueMeta( v );
    }

    if ( getLastModificationDateField() != null && getLastModificationDateField().length() > 0 ) {
      ValueMetaInterface v = new ValueMetaString( space.environmentSubstitute( getLastModificationDateField() ));
      v.setOrigin( name );
      r.addValueMeta( v );
    }
    ...
    if ( StringUtils.isNotEmpty(getMetadataFieldName())) {
      r.addValueMeta( new ValueMetaString(space.environmentSubstitute(getMetadataFieldName())) );
    }
  }
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases )
    ...
    try {
      ...
      metadataFieldName = rep.getStepAttributeString( id_step, "metadataFieldName" );
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step )
    ...
    try {
      ...
      rep.saveStepAttribute( id_transformation, id_step, "metadataFieldName", metadataFieldName );
  ...
  public void check( List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev, String input[],
    ...
    if ( input.length <= 0 ) {
      cr =
        new CheckResult( CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString( PKG, "LoadTextFromFileMeta.CheckResult.NoInputExpected" ), stepMeta );
      remarks.add( cr );
    } else {
    ...
    if ( getIsInFields() ) {
      ...
      if ( fileInputList == null || fileInputList.getFiles().size() == 0 ) {
        ...
        cr = new CheckResult( CheckResult.TYPE_RESULT_OK, BaseMessages.getString( PKG, "LoadTextFromFileMeta.CheckResult.FilesOk", "" + fileInputList
          .getFiles().size() ), stepMeta );
        remarks.add( cr );
      }
    }
   ...
   */
  public String exportResources( VariableSpace space, Map<String, ResourceDefinition> definitions, ResourceNamingInterface resourceNamingInterface,
